...
module.exports = app => {
  ...
  const user_group_mapping = app.model.define('user_group_mapping', {
  ...
  user_group_mapping.associate = function() {
    const ms = app.model.models;
    ms.user_group_mapping.belongsTo(ms.ad_group, { as: 'ad_group', foreignKey: 'groupId', constraint: false });
    ms.user_group_mapping.belongsTo(ms.user, { as: 'user', foreignKey: 'userId', constraint: false });
  };
